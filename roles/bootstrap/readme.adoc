...
For example, parameters named `operate_models_rhoai_bootstrap_*` would be recognized as unique to this workload.
...
* Add long-name scoped workload parameters. Example: `operate_models_rhoai_bootstrap_machineconfigpool_name: worker`
...
* `operate_models_rhoai_bootstrap_variable_1`
* `operate_models_rhoai_bootstrap_variable_2`
